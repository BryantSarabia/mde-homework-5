...
/**
 * This is the item provider adapter for a {@link RefinedStreamingPlatform.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider extends UserInteractionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefinedStreamingPlatformPackage.Literals.MESSAGE__CONTENT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Message_type") + " " + message.getUserInteractionID();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Message.class)) {
			case RefinedStreamingPlatformPackage.MESSAGE__CONTENT:
