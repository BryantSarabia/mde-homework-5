...
/**
 * This is the item provider adapter for a {@link RefinedStreamingPlatform.Playlist} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlaylistItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPlaylistIDPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Playlist ID feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPlaylistIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Playlist_playlistID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Playlist_playlistID_feature", "_UI_Playlist_type"),
				 RefinedStreamingPlatformPackage.Literals.PLAYLIST__PLAYLIST_ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RefinedStreamingPlatformPackage.Literals.PLAYLIST__MEDIA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RefinedStreamingPlatformPackage.Literals.PLAYLIST__MEDIA,
