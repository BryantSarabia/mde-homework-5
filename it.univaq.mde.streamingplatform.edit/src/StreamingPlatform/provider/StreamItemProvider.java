...
/**
 * This is the item provider adapter for a {@link StreamingPlatform.Stream} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StreamItemProvider extends MediaContentItemProvider {
	...
	/**
	 * This adds a property descriptor for the Stream ID feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addStreamIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Stream_streamID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Stream_streamID_feature", "_UI_Stream_type"),
				 StreamingPlatformPackage.Literals.STREAM__STREAM_ID,
				 false,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StreamingPlatformPackage.Literals.STREAM__IS_LIVE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StreamingPlatformPackage.Literals.STREAM__VIEWERS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Stream)object).getTitle();
