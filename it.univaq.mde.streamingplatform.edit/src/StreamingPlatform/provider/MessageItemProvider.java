...
/**
 * This is the item provider adapter for a {@link StreamingPlatform.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider extends UserInteractionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_messageID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_messageID_feature", "_UI_Message_type"),
				 StreamingPlatformPackage.Literals.MESSAGE__MESSAGE_ID,
				 false,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StreamingPlatformPackage.Literals.MESSAGE__CONTENT,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
