 ...
 * </p>
 * <ul>
 *   <li>{@link RefinedStreamingPlatform.impl.AuditableImpl#getCreatedAt <em>Created At</em>}</li>
 *   <li>{@link RefinedStreamingPlatform.impl.AuditableImpl#getUpdatedAt <em>Updated At</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AuditableImpl extends MinimalEObjectImpl.Container implements Auditable {
	...
	protected EClass eStaticClass() {
		return RefinedStreamingPlatformPackage.Literals.AUDITABLE;
	}
	...
	public void setCreatedAt(Date newCreatedAt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefinedStreamingPlatformPackage.AUDITABLE__CREATED_AT, oldCreatedAt, createdAt));
	}
	...
	public void setUpdatedAt(Date newUpdatedAt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefinedStreamingPlatformPackage.AUDITABLE__UPDATED_AT, oldUpdatedAt, updatedAt));
	}
